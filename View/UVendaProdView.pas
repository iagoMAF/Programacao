...
//  A function de alterar está disponivel, basta apenas adicionar o btn
//  Com o nome btnAlterar e tirar os comentarios das linhas :
//  218, 274 até 308, 395 até 399, 477.
...
begin
   ...
   'Essa função de deletar um produto, pode ser usada apenas no modo de inclusão.');
end;
