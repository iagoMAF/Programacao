object frmVendaPesq: TfrmVendaPesq
  ...
  object pnlFiltro: TPanel
    ...
    object grbFiltrar: TGroupBox
      ...
      object Label1: TLabel
        ...
        Width = 268
        Height = 13
        Caption = 'Digite parte ou todo o c'#243'digo da venda a ser pesquisado'
      end
  ...
  object pnlResultadoBusca: TPanel
    ...
    Align = alClient
    TabOrder = 1
    object grbResultadoBusca: TGroupBox
      Left = 4
      Top = 0
      Width = 695
      Height = 163
      ...
      TabOrder = 0
      object dbgVendaCliente: TDBGrid
        Left = 0
        Top = 16
        Width = 689
        Height = 145
        ...
        TitleFont.Style = []
        OnDblClick = dbgVendaClienteDblClick
        OnKeyDown = dbgVendaClienteKeyDown
        Columns = <
          item
            Expanded = False
            FieldName = 'VendaID'
  ...
  object dtsVendaCliente: TDataSource
    DataSet = cdsVendaCliente
    Left = 12
    Top = 145
  end
  object cdsVendaCliente: TClientDataSet
    ...
    Params = <>
    StoreDefs = True
    BeforeDelete = cdsVendaClienteBeforeDelete
    Left = 44
    Top = 145
    Data = {
    ...
    object cdsVendaClienteNomeCliente: TStringField
      FieldName = 'NomeCliente'
      Size = 100
    end
    object cdsVendaClienteDataVenda: TDateField
      FieldName = 'DataVenda'
    end
